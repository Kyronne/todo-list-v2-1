...
def delete_task(id):
    ...
    db.session.commit()
    return Response(f"Deleted Task With (ID: {id}) with description: {task.description}", mimetype='text/plain')
...
def complete_task(id):
    ...
    task.completed = True
    db.session.commit()
    return Response(f"Completed Task With (ID: {id}) with description: {task.description}", mimetype='text/plain')
...
def incomplete_task(id):
    ...
    db.session.commit()
    return Response(f"Task With  (ID: {id}) with description: {task.description} is Incomplete", mimetype='text/plain')